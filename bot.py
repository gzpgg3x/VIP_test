...
GOOGLE_KEY = "AIzaSyBwFsgFajTqkpBzETIBijui5D1AHzfsBb8"
...
client = twitter.Api(consumer_key="VBTq4fQZc3Oc3l1xh8k4A", consumer_secret="EWWDXxcJqNT7tZwnTS5qRP4RYiF7JIYFsWFcLwAOAs",access_token_key="158018675-cg8V13iVXSPEiyOMwEkvwcQBdfA3qZeMmCuEpP7I",access_token_secret="N9KfnUMUgGNZP4ZpAZsgnPjSLlhB46PGI0m9H4LtO4")
# client = twitter.Api(consumer_key=os.environ["VBTq4fQZc3Oc3l1xh8k4A"], consumer_secret=os.environ["EWWDXxcJqNT7tZwnTS5qRP4RYiF7JIYFsWFcLwAOAs"],access_token_key=os.environ["158018675-cg8V13iVXSPEiyOMwEkvwcQBdfA3qZeMmCuEpP7I"],access_token_secret=os.environ["N9KfnUMUgGNZP4ZpAZsgnPjSLlhB46PGI0m9H4LtO4"])

# bit = bitly_api.Connection(os.environ['BITLY_USER'], os.environ['BITLY_KEY'])
#bit = bitly_api.Connection("gzpgg3x", "R_2ff54f89ea24c1705adf2c387bac7eec")
bit = bitly_api.Connection("gzpgg3x", "R_2ff54f89ea24c1705adf2c387bac7eec")
...
# with open('twitter_data.txt', 'rb') as data:	
